...
internal static class IoUringConstants
{
    ...
    public const ulong ACCEPT_USER_DATA = ulong.MaxValue - 2;
    ...
    public const uint SOCK_NONBLOCK = 0x800;
    public const uint SOCK_CLOEXEC = 0x80000;
    ...
    public const uint IORING_REGISTER_FILES_UPDATE = 6;
